...
let Subcategory;
if (processed) {
  Subcategory = processed.model('Subcategory', subcategorySchema);
} else {
  // Fallback para desarrollo - usar conexión por defecto
  console.warn('⚠️  Processed connection not available, using default connection for Subcategory model');
