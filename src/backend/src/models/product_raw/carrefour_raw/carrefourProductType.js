...
// Modelo ProductType para la base de datos carrefour_raw
// Exportar función que toma la conexión para permitir uso genérico
module.exports = function(connection) {
  return connection.model('ProductType', productTypeSchema);
};