...
let ProductType;
if (carrefour) {
  ProductType = carrefour.model('ProductType', productTypeSchema);
} else {
  // Fallback para desarrollo - usar conexión por defecto
  console.warn('⚠️  Carrefour connection not available, using default connection for ProductType model');
