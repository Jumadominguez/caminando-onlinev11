...
def crawl_vea(output_dir):
    """
    Crawling básico de Vea para extraer outerHTML de páginas clave.
    """
    ...
    try:
        ...
        specific_urls = {
            "home": "https://www.vea.com.ar/",
            "categoria_almacen": "https://www.vea.com.ar/almacen",
            "producto_ejemplo": "https://www.vea.com.ar/galletitas-surtido-bagley-400-gr-2/p",
            "descuentos_dia": "https://www.vea.com.ar/descuentos-del-dia?type=por-dia&day=0",
            "descuentos_banco": "https://www.vea.com.ar/descuentos-del-dia?type=por-banco",
            "descuentos_cencopay": "https://www.vea.com.ar/descuentos-del-dia?type=cencopay"
        }
