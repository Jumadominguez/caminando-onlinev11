...
def crawl_jumbo(output_dir):
    """
    Crawling básico de Jumbo para extraer outerHTML de páginas clave.
    """
    ...
    try:
        ...
        specific_urls = {
            ...
            "producto_ejemplo": f"{base_url}/oblea-leche-4-fingers-41-5-grs-kitkat-2/p",
